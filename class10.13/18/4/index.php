...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center"><table width="700" border="0">
	  ...
	  <?php
	  include_once("conn/conn.php");// 包含数据库连接页
	  $result=mysqli_query($conn,"select * from tb_demo01");// 执行查询操作并返回结果集
		while($myrow=mysqli_fetch_object($result)){// 循环输出数据
	  ?>
      <tr>
        <td align="center"><span class="STYLE2"><?php echo $myrow->id; ?></span></td>
        <td align="left"><span class="STYLE2"><?php echo $myrow->name; ?></span></td>
        <td align="center"><span class="STYLE2"><?php echo $myrow->price; ?></span></td>
